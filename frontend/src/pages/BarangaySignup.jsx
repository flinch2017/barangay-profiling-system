...
export default function BarangaySignup() {
  ...
  const togglePassword = (field) => setShowPasswords((current) => ({ ...current, [field]: !current[field] }));
